...
export default function Onboarding2() {
  ...
  const handleNext = () => router.push("./onboarding-3" as any);
    ...
    <ThemedView style={styles.container}>
      <SafeAreaView style={styles.safeArea} edges={["top", "bottom"]}>
        ...
        <View pointerEvents="none" style={styles.bgIconWrap}>
          <Icons.chat width={250} height={250} color={theme.colors.primary} />
        </View>
        ...
        <View style={styles.content}>
          ...
          <View style={styles.textBlock}>
            <ThemedText
              ...
              weight="bold"
              style={styles.title}
              i18nKey="onboarding.askAiTitle"
            />

            <ThemedText
              style={styles.body}
              i18nKey="onboarding.askAiBody"
            />
          </View>
        ...
        <View style={styles.tabBarContainer}>
          <View style={[styles.tabBar, { borderColor: theme.colors.border }]}>
            ...
            <View style={styles.tabBarContent}>
              ...
              <Icons.chat width={36} height={36} color={theme.colors.primary} />

...
import { ThemedView, ThemedText, PageIndicator, NextButton, useTheme, Icons, Branding } from "@injured/ui";
...
export default function Onboarding3() {
  ...
  const handleNext = () => router.push("./onboarding-4" as any);
    ...
    <ThemedView style={styles.container}>
      <SafeAreaView style={styles.safeArea} edges={["top", "bottom"]}>
        ...
        <View pointerEvents="none" style={styles.bgIconWrap}>
          <Branding.logoIcon width={260} height={418} color={theme.colors.primary} />
        </View>
        ...
        <View style={styles.content}>
          ...
          <View style={styles.textBlock}>
            <ThemedText
              ...
              weight="bold"
              style={styles.title}
              i18nKey="onboarding.injuredTitle"
            >
              Injured?
            </ThemedText>
            ...
            <ThemedText
              style={styles.body}
              i18nKey="onboarding.injuredBody"
            >
              Navigate your personalized recovery process with ease. Injured guides you through steps tailored to your specific injury, ensuring you get the care you need at every stage of healing.
            </ThemedText>
          </View>
        ...
        <View style={styles.tabBarContainer}>
          <View style={[styles.tabBar, { borderColor: theme.colors.border }]}>
            ...
            <View style={styles.tabBarContent}>
              <Icons.home width={36} height={36} color={theme.colors.iconSecondary} onPress={() => router.push("./onboarding-1" as any)} />
              <Icons.chat width={36} height={36} color={theme.colors.iconSecondary} onPress={() => router.push("./onboarding-2" as any)} />
              <View style={{ width: 50, height: 50, borderRadius: 99, overflow: "hidden", backgroundColor: theme.colors.primary, justifyContent: "center", alignItems: "center" }}>
                <Branding.logoIcon width={24} height={36} color={'white'} />
              </View>              

...
export default function Onboarding4() {
  ...
  const handleNext = () => router.push("./onboarding-5" as any);
        ...
        <View style={styles.content}>
          ...
          <View style={styles.textBlock}>
            <ThemedText
              ...
              weight="bold"
              style={styles.title}
              i18nKey="onboarding.providersTitle"
            >
              Specialists
            </ThemedText>
            ...
            <ThemedText
              style={styles.body}
              i18nKey="onboarding.providersBody"
            >
              See all the specialists connected to your recovery. Easily view and contact providers in the Injured network so you know exactly who's on your team.
            </ThemedText>
          </View>
        ...
        <View style={styles.tabBarContainer}>
          <View style={[styles.tabBar, { borderColor: theme.colors.border }]}>
            ...
            <View style={styles.tabBarContent}>
              ...
              <Icons.provider width={36} height={36} color={theme.colors.primary} />

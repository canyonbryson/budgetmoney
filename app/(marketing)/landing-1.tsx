...
export default function Landing1() {
  ...
  const handleNext = () => {
    router.push("/(marketing)/landing-2");
  };

  return (
    <ImageBackground
      source={LandingAssets.landing1Background}
      ...
      <SafeAreaView style={styles.safeArea} edges={["bottom"]}>
        ...
        <View style={styles.content}>
          <View style={styles.textContainer}>
            <ThemedText variant="heading" color={theme.colors.textSecondary} i18nKey="landing1.title" />
            <ThemedText i18nKey="landing1.body" />
          </View>
